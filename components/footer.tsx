      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-primary-light">JJC Puerto Princesa Perlas</h3>
            ...
            <div className="flex items-center space-x-4 mt-4">
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-primary/20 hover:bg-primary/30 text-white transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link href="/leadership" className="hover:text-primary-light transition-colors">
                  Leadership
                </Link>
              </li>
              <li>
                <Link href="/events" className="hover:text-primary-light transition-colors">
                  Events
                </Link>
              </li>
              <li>
                <Link href="/membership" className="hover:text-primary-light transition-colors">
                  Membership
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-primary-light">Contact</h4>
